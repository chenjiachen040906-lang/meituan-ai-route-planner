...
from utils import render_route_card, render_location_map, _render_map_widget
...
with st.expander("⚙️ 约束条件", expanded=False):
    ...
    with col2:
        ...
        if start_location and search_clicked:
            with st.spinner("正在搜索位置..."):
                render_location_map(start_location)
